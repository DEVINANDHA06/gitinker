...
The home page also includes a quick catalog summary showing the total number of games and the average star rating across all rated titles, with graceful handling for empty or unrated catalogs.
